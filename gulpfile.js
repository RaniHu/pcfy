...
gulp.task('htmlmin', function () {
    ...
    gulp.src('./src/*.html')
        ...
        .pipe(gulp.dest('./'));
    gulp.src('./src/block-info/*.html')
        .pipe(htmlmin(options))
        .pipe(gulp.dest('./block-info'));
});
...
gulp.task('minifycss', function () {
    return gulp.src(['./src/css/reset.css','./src/css/swiper.css','./src/css/**/*.css'])
...
gulp.task('minifyjs', function () {
    return gulp.src(['./src/js/jquery-1.9.1-min.js','./src/js/swiper.js','./src/js/**/*.js'])
...
gulp.task('clean', function () {
    return del(['./index.html','./block-info/*.html','./src/css/*.min.css','./src/css/main.css', './css/*.min.css', './js/*.js','./src/js/*.min.js','./src/js/main.js'])
});
